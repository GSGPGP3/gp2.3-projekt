...
######################################
	...
	$sql_pw = ""; //Das Passwort des MySQL-DB-Servers --> sollte nicht leer sein
	...
	mysql_connect("$adresse", "$benutzername","$sql_pw")or die ("Keine Verbindung moeglich!");
	mysql_select_db("$datenbank") or die ("Keine Datenbank vorhanden!");
	mysql_query("SET NAMES 'utf8'"); // Wichtig - SET NAMES setzt die drei Systemvariablen character_set_client, character_set_connection und character_set_results auf den angegebenen Zeichensatz
